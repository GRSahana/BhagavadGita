...
interface VerseDao {
    ...
    @Query("UPDATE verse_info SET favorite = :favorite WHERE id = :id")
    suspend fun updateVerseFavStatus(id : Int, favorite : Int):Int

    @Query("UPDATE verse_info SET read_status = :readStatus WHERE id = :id")
    suspend fun updateVerseReadStatus(id : Int, readStatus : Int):Int
