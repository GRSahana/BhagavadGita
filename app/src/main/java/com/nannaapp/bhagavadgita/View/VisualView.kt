...
class VisualView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private var primaryWaveLineWidth = 5.0f // outer line stroke
    private var secondaryWaveLineWidth = 2.5f // inner line stroke
    ...
    fun updateNumberOfWaves(num: Float) {
        numberOfWaves = num
    }

//    fun updatePrimaryLineStroke(phase: Float) {
//        phaseShift = phase
//    }
